...
_aMaxQOutHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_) _AND_ ( _uDepthWHyp_ _GT_ _cMinDepthHypEpi_ ) _THEN_ (_uDepthWHyp_ - _cMinDepthHypEpi_) * _mmPerm_ * _cMaxWOut_ _ELSE_ 0.0 _ENDIF_;
