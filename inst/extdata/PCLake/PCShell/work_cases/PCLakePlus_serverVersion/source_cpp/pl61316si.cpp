...
_sDPisc0_ = _cDPisc0_;
_MassEpi0_ = _IF_ (_CalcMass_ _EQ_ _FALSE_) _THEN_ 1.0 _ELSEIF_ (_aInclStrat0_ _EQ_ _FALSE_) _THEN_ _sDepthW0_ _ELSEIF_ (_sDepthW0_  _LT_ _sMixDepthW0_) _THEN_ _sDepthW0_ _ELSE_ _sMixDepthW0_ _ENDIF_;
